...
;; find-pattern-in-source: [Vectorof [Vectorof Pixel]]
;;                         [Vectorof [Vectorof Pixel]]
;;                         ->
...
(: find-pattern-in-source : (Vectorof (Vectorof pixel)) (Vectorof (Vectorof pixel)) -> (Listof (List Integer Integer)))
(define (find-pattern-in-source pattern source)
  (find-pattern-in-source/tolerance pattern source 0))

(: find-pattern-in-source/tolerance : (Vectorof (Vectorof pixel)) (Vectorof (Vectorof pixel)) Number -> (Listof (List Integer Integer)))
...
(: find-pattern-in-source-at : Integer Integer (Vectorof (Vectorof pixel)) (Vectorof (Vectorof pixel)) Integer -> Boolean)
